  ...
  return (
    <div className=" bg-white border-b-[#09b6cb] border-b-4  ">
      <div className="h-12 bg-sky-950 text-gray-300 flex justify-end gap-4 px-2 md:px-20 md:gap-12 py-3">
        <div className=" md:text-base text-sm flex justify-center items-center gap-2">
          {" "}
          <IoMdMail className="text-xl text-orange-500"></IoMdMail>{" "}
        ...
        <div className="md:text-base  text-sm flex justify-center items-center gap-2">
          {" "}
          <BsFillTelephoneFill className="text-xl text-orange-500"></BsFillTelephoneFill>{" "}
          <div><a href={phoneHref1}>{phone1}</a></div>
        </div>
        <div className="md:text-base text-sm flex justify-center items-center gap-2">
          {" "}
          <BsFillTelephoneFill className="text-xl text-orange-500"></BsFillTelephoneFill>{" "}
          <div><a href={phoneHref2}>{phone2}</a></div>
        </div>
      </div>
      <div className="flex  justify-around items-center py-4 text-lg  ">
        ...
        <div className=" pr-12 font-Titillium font-semibold   justify-evenly ml-6 text-black  ">
          <ul className="md:flex lg:gap-x-3 xl:gap-4 2xl:gap-0 md:items-center  hidden list-none text-sm">
            <li className="relative after:content-[''] pb-2 after:block after:h-[4px] after:w-[100%] after:bg-orange-400 after:scale-x-0 after:origin-left after:ease-in-out after:duration-300 after:hover:scale-x-100  2xl:pr-6 2xl:pl-3 transition-all delay-100 ease-in cursor-pointer">
              <Link className={path === "/" ? "change" : ""} to="/">
                Home
              </Link>
            </li>
            <li className="relative after:content-[''] pb-2 after:block after:h-[4px] after:w-[100%] after:bg-orange-400 after:scale-x-0 after:origin-left after:ease-in-out after:duration-300 after:hover:scale-x-100  2xl:pr-6 2xl:pl-3  transition-all delay-100 ease-in cursor-pointer">
              <Link className={path === "/Causes" ? "change" : ""} to="/Causes">
                Causes
              </Link>
            </li>
            ...
            >
              <Link className=" flex">
                <p
                // className={(path=== '/Events' || path==='/Blog' || path==='/NewsRoom')? "change":""}
                >
                  Our Program
                </p>
                {!openDrop1 ? (
              ...
              {openDrop1 && (
                <div className=" z-50   bg-white absolute   transition-all ease-in-out delay-500">
                  <div className="flex flex-col w-52 justify-center relative bg-white  text-sm">
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/">Skill Development</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/">Adult Education</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/">Health Care</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/">Environment Protection</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/">More...</Link>
                    </div>
            ...
            >
              ...
              {openDrop2 && (
                <div className=" z-50   bg-white absolute   transition-all ease-in-out delay-500">
                  <div className="flex flex-col w-52 justify-center relative bg-white  text-sm">
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/Purpose">Educate the Future</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/Purpose">Adult Education</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/Purpose">Women & Child Welfare</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/Purpose">Skill Development</Link>
                    </div>
                  </div>
                </div>
              )}
            ...
            >
              ...
              {openDrop3 && (
                <div className=" z-50   bg-white absolute   transition-all ease-in-out delay-500">
                  <div className="flex flex-col w-52 justify-center relative bg-white  text-sm">
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/AboutOF">About OF</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/NewsRoom">Our Financials</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/Approvals">Awards and Approvals</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/Events">Annual Reports</Link>
                    </div>
                  </div>
                </div>
              )}
              ...
              {openDrop && (
                <div className=" z-50   bg-white absolute   transition-all ease-in-out delay-500">
                  <div className="flex flex-col w-52 justify-center relative bg-white  text-sm">
                    ...
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
                      <Link to="/NewsRoom">News And Press Release</Link>
                    </div>
                    <div className="border-b-2 px-4 py-2 hover:bg-orange-500 hover:text-white transition-all duration-500">
            ...
            <li className="mb-4">
              <Link className="hover:text-orange-500 transition-all">
                {" "}
            ...
            <li>
              <Link to="/Causes">
                <button className=" md:py-2 md:mb-4 2xl:ml-6 lg:px-1 2xl:px-6  px-4 py-2 border-2 text-white rounded-2xl hover:text-orange-500  border-orange-500 font-medium bg-orange-500  hover:bg-transparent transition-all delay-100 ease-in-out ">
                  Donate Now
                </button>
              </Link>
            </li>
        ...
        >
          {" "}
          <AiOutlineMenu className="" size={40} />
        </div>
      </div>
      ...
      <div
        className={
          open
            ? ` bg-white w-full h-[60vh]  ease-in-out duration-500 z-50 absolute top-0 left-0`
            : "left-[-100%] fixed trans"
        }
      >
          ...
          <ul className=" list-none">
            ...
            <li className="p-4  hover:text-orange-500 transition-all delay-100 ease-in cursor-pointer">
              <button className=" text-center">
                <Link
                  to="/donations"
                  className="  md:py-4 md:px-5 md:font-medium  "
                >
                  Donate Now
                </Link>
              </button>
